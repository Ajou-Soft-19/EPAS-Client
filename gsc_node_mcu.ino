...
void setup() {
  ...
  latitude = 127.105997; longitude = 37.352690; course=10;
...
void handleLocationConfidence(const JsonObject& data) {
  if (data["location"]["confidence"].isNull()) {
    ...
    const char* confidence = data["location"]["confidence"].as<const char*>();
    Serial.print("[MSG] ");
...
void printAlertSpeaker(int vehicleIndex) {
  ...
  if (direction == "N") directionCode = 9;
  else if (direction == "NE") directionCode = 8;
  else if (direction == "E") directionCode = 7;
  else if (direction == "SE") directionCode = 6;
  else if (direction == "S") directionCode = 5;
  else if (direction == "SW") directionCode = 4;
  else if (direction == "W") directionCode = 3;
  else if (direction == "NW") directionCode = 2;
  else directionCode = 1;
